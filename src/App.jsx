      ...
      <div style={{ padding: "20px 28px 28px" }}>
        ...
        <FormGroup label="📸 Photos">
          <div onClick={() => fileRef.current.click()} style={{
            ...
            background: "#FDE8D5", cursor: "pointer", transition: "all 0.2s",
          }}
            onMouseEnter={e => { e.currentTarget.style.borderColor="#E07A3A"; e.currentTarget.style.background="#FDD8B5"; }}
            onMouseLeave={e => { e.currentTarget.style.borderColor="#F5C59C"; e.currentTarget.style.background="#FDE8D5"; }}
          >
            ...
            <span style={{ fontSize: "0.82rem", color: "#B8936A" }}>JPG, PNG, WEBP supported</span>
          </div>
          {images.length > 0 && (
        ...
        <div style={{ display: "flex", gap: 12, justifyContent: "flex-end", paddingTop: 20, borderTop: "1px solid #E8D9C4", marginTop: 8 }}>
          ...
          <button onClick={handleSave} style={{ background: "#E07A3A", border: "none", borderRadius: 12, padding: "10px 28px", fontFamily: "'Caveat', cursive", fontSize: "1.1rem", fontWeight: 700, color: "white", cursor: "pointer", boxShadow: "0 4px 14px rgba(224,122,58,0.3)" }}>💾 Save Recipe</button>
        </div>
      </div>
    </ModalShell>
  );
